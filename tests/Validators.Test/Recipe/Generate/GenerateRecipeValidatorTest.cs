...
public class GenerateRecipeValidatorTest
{
    ...
    public void Error_More_Maximum_Ingredients() 
    {
        ...
        result.Errors.Should().ContainSingle()
            .And.Contain(error => error.ErrorMessage.Equals(ResourceMessagesException.INVALID_NUMBER_INGREDIENTS));
    }
    [Fact]
    public void Error_Duplicated_Ingredients()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().ContainSingle()
            .And.Contain(error => error.ErrorMessage.Equals(ResourceMessagesException.DUPLICATED_INGREDIENTS_IN_LIST));
    }
    [Theory]
    [InlineData(null)]
    [InlineData("         ")]
    ...
    public void Error_Empty_Ingredient(string ingredient)
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().ContainSingle()
            .And.Contain(error => error.ErrorMessage.Equals(ResourceMessagesException.INGREDIENT_EMPTY));
    }
    [Fact]
    public void Error_Ingredient_Not_Following_Pattern()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().ContainSingle()
            .And.Contain(error => error.ErrorMessage.Equals(ResourceMessagesException.INGREDIENT_NOT_FOLLOWING_PATTERN));
    }
}
