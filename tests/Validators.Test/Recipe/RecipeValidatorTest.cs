...
public class RecipeValidatorTest
{
    ...
    public void Error_Invalid_Cooking_Time()
    {
        ...
        var request = RequestRecipeJsonBuilder.Build();
        request.CoockingTime = (MyRecipeBook.Communication.Enums.CookingTime?)1000;
    ...
    public void Error_Invalid_Difficulty()
    {
        ...
        var request = RequestRecipeJsonBuilder.Build();
        request.Difficulty = (MyRecipeBook.Communication.Enums.Difficulty?)50;
    ...
    public void Error_Title_Empty(string title)
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().ContainSingle().And
            .Contain(e => e.ErrorMessage.Equals(ResourceMessagesException.RECIPE_TITLE_EMPTY));
    }
    [Fact]
